	...
	class Comodato extends CI_Controller{	
		...
		public function comodato_management(){	
			...
			$crud->field_type('comision_paga','dropdown',
				...
				$crud->required_fields('idInmueble','locador','operacion','locatario1','garante1','fechaInicio','punitorio','fechaPago','duracion','fechaFin','valor1','tipo_ajuste','ajuste','comision_paga');				
...
public function imprimir_gastos_alquiler(){
	...
	public function comodato_edit(){
		...
		$crud->edit_fields('idInmueble','locador','operacion','locatario1','locatario2','garante1','garante2','garante3','garante4','fechaInicio','duracion','fechaFin','fechaPago','proxVenc','punitorio','comision_admin','tipo_ajuste','ajuste','valor1','valor2','valor3','valor4','valor5','valor6','comision_inmo_a_pagar','comision_paga','sellado_contrato','fecha_firma','escribano','rescinde_dentro','rescinde_fecha','estado_contrato','rescision');
			...
			$crud->required_fields('idInmueble','locador','operacion','locatario1','garante1','fechaInicio','punitorio','fechaPago','duracion','valor1','tipo_ajuste','ajuste');			
